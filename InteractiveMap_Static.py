...
# )
# def update_fig_based_on_year(selected_year):

#     avg_score_per_province = filtered_data.groupby('PROVINCE')['Overall CMCI Score'].mean().reset_index()

#     updated_fig = px.choropleth(
#         avg_score_per_province,
#         geojson=filtered_data.geometry,
#         locations=filtered_data.index,
#         color='Overall CMCI Score',  
#         color_continuous_scale='Viridis',
#         labels={'Overall CMCI Score': 'Average Score'},  
#     )

#     updated_fig.update_geos(fitbounds="locations", visible=False, bgcolor="#C9D1D2")
#     updated_fig.update_layout(
#         title=f'Average CMCI Score per Province for {selected_year}',
...
>>>>>>> 7a3cc475e6d6451dc7f161ffc7a57849588f7202
